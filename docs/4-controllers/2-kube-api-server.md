...
# The API Server is what you interact with. All requests made via Kubectl or even curl hit the API Server.
# The API Server receives the request and then sends messages to the other services as required.
